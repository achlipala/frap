...
| HtFail : forall {result},
    hoare_triple linvs (fun _ => False) (Fail (result := result)) (fun _ _ => False)
| HtRead : forall a R,
...
| HtPar : forall P1 c1 Q1 P2 c2 Q2,
    ...
    -> hoare_triple linvs P2 c1 Q2
    -> hoare_triple linvs (P1 * P1)%sep (Par c1 c2) (fun _ => Q1 tt * Q2 tt)%sep
