...
\chapter{Type-Theoretic Foundations of Proof Assistants}
...
An important property of this relation is that it is \emph{decidable}\index{decidable}: that exists an algorithm that takes in two expressions and decides if they are equal according to the relation.
...
Note how the final rule pushed cumulatively through $\forall$ types, following a similar pattern to subtyping of functions\index{subtyping} in other languages.
